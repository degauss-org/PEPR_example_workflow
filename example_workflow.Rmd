...
See the [Installing Docker](https://github.com/cole-brokamp/DeGAUSS/wiki/Installing-Docker) wiki.
 ...
 > <font size="3.5"> **_Note about Docker Settings:_** </font> <br> <font size="2.75"> Before running any containers, go to **Docker Settings > Advanced** and change **memory** to greater than 4000 MB (or 4 GiB) <br> <center> <img width=50% src="images/docker_settings_memory.PNG"> </center> <br> If you are using Windows, additionally, set **CPUs** to 1. <br> <center> <img width=50% src="images/docker_settings_cpu.png"> </center> </font>
